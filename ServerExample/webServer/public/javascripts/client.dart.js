...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|Blob|DOMError|DOMImplementation|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|Range|SQLError|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["", "client.dart", , U, {
  "^": "",
  main: [function() {
    var input, output, ws, t1;
    input = document.querySelector("#input");
    output = document.querySelector("#output");
    ws = W.WebSocket_WebSocket("ws://104.236.98.132:10000/", null);
    t1 = H.setRuntimeTypeInfo(new W._EventStream(ws, "open", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.main_closure(output)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(ws, "message", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.main_closure0(output)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(ws, "close", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.main_closure1(output)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onChange$x(input);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.main_closure2(input, ws)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 0],
  outputMessage: function(e, message) {
    P.print(message);
    e.toString;
    e.appendChild(document.createTextNode(message));
    J.insertAdjacentHtml$2$x(e, "beforeend", "<br/>");
    e.scrollTop = C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(e.scrollHeight))));
  },
  main_closure: {
    "^": "Closure:13;output_0",
    call$1: function(e) {
      U.outputMessage(this.output_0, "Connected to server");
    }
  },
  main_closure0: {
    "^": "Closure:14;output_1",
    call$1: function(e) {
      U.outputMessage(this.output_1, J.get$data$x(e));
    }
  },
  main_closure1: {
    "^": "Closure:13;output_2",
    call$1: function(e) {
      U.outputMessage(this.output_2, "Connection to server lost...");
    }
  },
  main_closure2: {
    "^": "Closure:13;input_3,ws_4",
    call$1: function(e) {
      var arg, e0, t1, t2, exception;
      try {
        t1 = this.input_3;
        t2 = J.getInterceptor$x(t1);
        arg = J.split$1$s(t2.get$value(t1), " ");
        this.ws_4.send(C.JsonCodec_null_null.encode$1(P.LinkedHashMap_LinkedHashMap$_literal(["command", J.$index$asx(arg, 0), "params", J.sublist$1$ax(arg, 1)], null, null)));
        t2.set$value(t1, "");
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e0 = t1;
...
["dart.async", "dart:async", , P, {
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 16, 17],
    $is_Future: true,
    $isFuture: true,
...
["dart.collection", "dart:collection", , P, {
  ...
  ListMixin: {
    ...
    sublist$2: function(receiver, start, end) {
      ...
      for (i = 0; i < $length; ++i) {
        t1 = this.$index(receiver, start.$add(0, i));
        if (i >= result.length)
          return H.ioore(result, i);
        result[i] = t1;
      }
